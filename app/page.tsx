  ...
  const features = [
    {
      ...
      description: "Notre algorithme analyse vos préférences, votre localisation et votre personnalité pour vous suggérer les profils les plus compatibles.",
      color: "text-rose-500",
      bg: "bg-rose-500/10",
    },
    {
      ...
      description: "Chaque profil est vérifié manuellement par notre équipe. Pas de faux comptes, pas de robots — que des personnes sérieuses.",
    ...
    },
    {
      ...
      description: "Discutez en toute confiance avec vos matchs. Messages chiffrés, appels vidéo intégrés et notifications en temps réel.",
      color: "text-blue-500",
      bg: "bg-blue-500/10",
    },
    {
      ...
      description: "20 questions sur vos valeurs, votre mode de vie, votre religion et votre vision du mariage pour des matchs parfaits.",
  ...
  const testimonials = [
    {
      ...
      text: "Nawa Mariage a changé notre vie. Nous nous sommes rencontrés en janvier et nous nous marions en décembre !",
      rating: 5,
    },
    {
      name: "Fatima & Omar",
      location: "Dakar, Sénégal",
      text: "Le questionnaire de compatibilité est incroyable. Nous avons 94% de match et c'est vrai, nous sommes faits l'un pour l'autre.",
      rating: 5,
    },
    {
      name: "Aïcha & Moussa",
      location: "Abidjan, Côte d'Ivoire",
      text: "Enfin une application sérieuse pour les musulmans qui veulent se marier. Pas de perte de temps, que du sérieux.",
      rating: 5,
    },
  ];

  // Formater les nombres (ex: 1247 → "1,247+")
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login/" className="hidden sm:block text-gray-600 hover:text-gray-900 transition font-medium">
              Se connecter
            </Link>
            <Link href="/register/" className="px-5 py-2.5 bg-primary-600 text-white rounded-xl font-medium hover:bg-primary-700 transition shadow-lg shadow-primary-600/20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-100 text-primary-700 rounded-full text-sm font-medium mb-6">
                ...
                L'application #1 pour le mariage en Afrique
              </div>
              ...
              <div className="flex items-center gap-6 mt-10">
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-bold text-gray-900">{formatNumber(stats.totalUsers)}</span> célibataires nous font confiance
                </p>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-6 border border-gray-100 relative">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="ml-auto px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-bold">
                      94% Match
                    </div>
                  </div>
                ...
                <div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-lg p-3 border border-gray-100 animate-bounce" style={{ animationDuration: '3s' }}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold">Nouveau match !</span>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-2">
                {loading ? "..." : formatNumber(stats.totalCouples)}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              4 étapes simples pour trouver votre âme sœur
            </p>
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              La première application de rencontre musulmane 100% axée sur le mariage
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary-600 to-secondary-600">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Prêt à trouver votre âme sœur ?
          </h2>
          <p className="text-xl text-white/80 mb-10">
            Rejoignez {loading ? "..." : formatNumber(stats.totalUsers)} célibataires musulmans sérieux et commencez votre histoire dès aujourd'hui.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/register/" className="px-10 py-4 bg-white text-primary-600 rounded-xl font-bold hover:bg-gray-100 transition shadow-xl">
              Créer mon compte gratuit
            </Link>
            <Link href="/discover/" className="px-10 py-4 bg-primary-700 text-white rounded-xl font-bold hover:bg-primary-800 transition border-2 border-white/20">
              Voir les profils
            </Link>
          </div>
          <p className="text-white/60 mt-6 text-sm">
            Gratuit • Sans engagement • Profils vérifiés
          </p>
        </div>
      </section>
      ...
      <footer className="bg-gray-950 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                La première application de rencontre musulmane 100% axée sur le mariage en Afrique.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-500 text-sm">
            © 2026 Nawa Mariage. Tous droits réservés.
          </div>
        </div>
      </footer>
    </div>
